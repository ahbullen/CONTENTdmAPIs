...
$xmlData = file_get_contents("https://server16614.contentdm.oclc.org/dmwebservices/index.php?q=dmQuery/all/title^$searchTerm^all^and/title!subjec!descri/title/100/1/0/0/0/0/xml");
	...
	<body>
		<div class="container">
			...
			<header>
		                        ...
		                        <h1 style="text-align: center;">Illinois Digital Archives Search Results</h1>
                		        <h2 style="text-align: center;">Searched for <?php echo "<em>$searchTerm</em>\n"; ?>, with <?php echo $numberOfHits ?> results</h2>
				</nav>
			</header>
...
for ($i=0;$i<=$resultCount;$i++) {
	...
	echo "<li><a href=\"dmMoreSophisticatedItemInfo.php?collection=$collection&pointer=$thumb\"><img src=\"$imgStr\"></a><br />$title</li>\n";
}
?>
